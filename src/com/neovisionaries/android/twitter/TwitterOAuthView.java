...
/**
 * A {@link android.webkit.WebView} subclass dedicated to Twitter OAuth on Android,
 ...
 * view = new {@link TwitterOAuthView#TwitterOAuthView(android.content.Context) TwitterOAuthView}(this);
 * <p/>
 * setContentView(view);
 * <p/>
 * oauthStarted = false;
...
public class TwitterOAuthView extends WebView {
    ...
    /**
     * A constructor that calls {@link android.webkit.WebView#WebView(android.content.Context, android.util.AttributeSet, int)
    ...
    /**
     * A constructor that calls {@link android.webkit.WebView#WebView(android.content.Context, android.util.AttributeSet)
     * super}(context, attrs).
     *
     * @param context
     * @param attrs
    ...
    /**
     * A constructor that calls {@link android.webkit.WebView#WebView(android.content.Context) super}(context).
     *
     * @param context
     */
     ...
     * @param listener
     * @throws IllegalArgumentException At least one of 'consumerKey', 'consumerSecret' or
     *                                  'callbackUrl' is null.
     */
